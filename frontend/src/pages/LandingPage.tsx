...
export default function LandingPage() {
  ...
  return (
    <div style={{ backgroundColor: "var(--color-bg)", minHeight: "100vh" }}>
      ...
      >
        <div className="container hero-grid">
          <div>
            ...
            >
              Connect your documents, websites, and business data. Deploy AI
              assistants that answer with verified sources and zero guesswork.
            </p>
            <div
              style={{
                display: "flex",
            ...
            >
              ...
              >
                <Check size={16} color="var(--color-text-main)" /> No credit
                card
              </span>
              <span
                style={{ display: "flex", alignItems: "center", gap: "6px" }}
              >
                <Check size={16} color="var(--color-text-main)" /> Setup in
                minutes
              </span>
              <span
                style={{ display: "flex", alignItems: "center", gap: "6px" }}
              >
                <Check size={16} color="var(--color-text-main)" /> Cancel
                anytime
              </span>
            </div>
          </div>
          ...
          <div className="mockup" style={{ display: "flex", height: "480px" }}>
            ...
            >
              ...
              >
                ...
                >
                  Enterprise customers are eligible for a full refund within 30
                  days of purchase, provided they have not exceeded 80% of their
                  monthly usage limit.
                  <div
                    style={{
                      marginTop: "16px",
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <FileText size={14} /> Refund Policy - Acme Corp.pdf
                      </div>
                      <div
                        style={{
                          display: "flex",
                    ...
                    >
                      ...
                      >
                        <FileText size={14} /> Terms of Service - Acme Corp.pdf
                      </div>
                      <div
                        style={{
                          display: "flex",
                    ...
                    >
                      ...
                      >
                        <FileText size={14} /> Enterprise Agreement.docx
                      </div>
                      <div
                        style={{
                          display: "flex",
            ...
            >
              ...
              >
                ...
                >
                  AI answers are generated only from your connected knowledge
                  sources.
                </div>
      ...
      <section
        className="section"
        style={{ backgroundColor: "var(--color-bg-soft)", textAlign: "center" }}
      >
        <div className="container">
          <div className="small-label">THE PROBLEM</div>
          <h2 className="section-title" style={{ marginBottom: "64px" }}>
            Knowledge is <span className="text-gradient">everywhere</span>,
            answers are not.
          </h2>
          ...
          <div
            ...
            className="problem-chain-mobile"
          >
      ...
      <section className="section" style={{ textAlign: "center" }}>
        <div className="container">
          ...
          <h2 className="section-title" style={{ marginBottom: "64px" }}>
            From any source to{" "}
            <span className="text-gradient">trusted answers</span>.
          </h2>
          ...
          >
            ...
            >
              ...
              <p className="body-text" style={{ fontSize: "14px" }}>
                Upload files, connect apps, or crawl websites.
              </p>
              <div
                style={{
                  display: "flex",
      ...
      <section className="section trust-section">
        <div className="container hero-grid">
          <div>
            ...
            >
              Every answer is grounded in your knowledge and linked back to its
              original source.
            </p>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  leave per calendar year, in addition to public holidays..."
                </div>
                <div
                  style={{
                    display: "flex",
      ...
      >
        <div className="container">
          ...
          <h2 className="section-title" style={{ marginBottom: "64px" }}>
            ...
            <span className="text-gradient">modern</span> RAG platform.
          </h2>
              ...
              >
                {activeTab === "Customer Support"
                  ...
                  : activeTab === "HR & People Ops"
                    ...
                    : activeTab === "Legal"
                      ? "Search contracts with confidence"
                      : activeTab === "Education"
                        ? "Empower students with instant answers"
            ...
            >
              ...
              >
                ...
                <svg width="100" height="30" style={{ marginTop: "8px" }}>
                  <polyline
                    points="0,25 20,15 40,20 60,5 80,10 100,2"
                    fill="none"
      ...
      <section style={{ padding: "0 24px" }}>
        <div
          className="container security-banner"
          style={{
            display: "flex",
            justifyContent: "space-between",
            alignItems: "center",
          ...
          <div className="pricing-grid text-left">
            ...
            >
              ...
              >
                ...
                >
                  <Check size={16} color="var(--color-primary)" /> 1 Workspace
                </li>
                <li
                  style={{ display: "flex", alignItems: "center", gap: "8px" }}
                >
                  <Check size={16} color="var(--color-primary)" /> 50 Documents
                </li>
                <li
                  style={{ display: "flex", alignItems: "center", gap: "8px" }}
                >
                  <Check size={16} color="var(--color-primary)" /> 100 Questions
                  / month
                </li>
                <li
                  style={{ display: "flex", alignItems: "center", gap: "8px" }}
                >
                  <Check size={16} color="var(--color-primary)" /> Basic AI
                  Models
                </li>
              </ul>
            ...
            >
              ...
              >
                <li
                  style={{ display: "flex", alignItems: "center", gap: "8px" }}
                >
                  <Check size={16} color="var(--color-purple)" /> 3 Workspaces
                </li>
                <li
                  style={{ display: "flex", alignItems: "center", gap: "8px" }}
                >
                  <Check size={16} color="var(--color-purple)" /> 5,000
                  Documents
                </li>
                <li
                  style={{ display: "flex", alignItems: "center", gap: "8px" }}
                >
                  <Check size={16} color="var(--color-purple)" /> 10,000
                  Questions / month
                </li>
                <li
                  style={{ display: "flex", alignItems: "center", gap: "8px" }}
                >
                  <Check size={16} color="var(--color-purple)" /> Advanced AI
                  Models
                </li>
                <li
                  style={{ display: "flex", alignItems: "center", gap: "8px" }}
                >
                  <Check size={16} color="var(--color-purple)" /> Priority
                  Support
                </li>
              </ul>
            ...
            >
              ...
              >
                <li
                  style={{ display: "flex", alignItems: "center", gap: "8px" }}
                >
                  <Check size={16} color="var(--color-primary)" /> Unlimited
                  Workspaces
                </li>
                <li
                  style={{ display: "flex", alignItems: "center", gap: "8px" }}
                >
                  <Check size={16} color="var(--color-primary)" /> 25,000
                  Documents
                </li>
                <li
                  style={{ display: "flex", alignItems: "center", gap: "8px" }}
                >
                  <Check size={16} color="var(--color-primary)" /> 50,000
                  Questions / month
                </li>
                <li
                  style={{ display: "flex", alignItems: "center", gap: "8px" }}
                >
                  <Check size={16} color="var(--color-primary)" /> API Access
                </li>
                <li
                  style={{ display: "flex", alignItems: "center", gap: "8px" }}
                >
                  <Check size={16} color="var(--color-primary)" /> Analytics
                  Dashboard
                </li>
                <li
                  style={{ display: "flex", alignItems: "center", gap: "8px" }}
                >
                  <Check size={16} color="var(--color-primary)" /> Team
                  Management
                </li>
              </ul>
              <button className="btn-secondary" style={{ width: "100%" }}>
            ...
            >
              ...
              >
                <li
                  style={{ display: "flex", alignItems: "center", gap: "8px" }}
                >
                  <Check size={16} color="var(--color-text-main)" /> Everything
                  in Business
                </li>
                <li
                  style={{ display: "flex", alignItems: "center", gap: "8px" }}
                >
                  <Check size={16} color="var(--color-text-main)" /> SSO / SAML
                </li>
                <li
                  style={{ display: "flex", alignItems: "center", gap: "8px" }}
                >
                  <Check size={16} color="var(--color-text-main)" /> Private
                  Deployment
                </li>
                <li
                  style={{ display: "flex", alignItems: "center", gap: "8px" }}
                >
                  <Check size={16} color="var(--color-text-main)" /> Dedicated
                  Support
                </li>
                <li
                  style={{ display: "flex", alignItems: "center", gap: "8px" }}
                >
                  <Check size={16} color="var(--color-text-main)" /> Custom SLAs
                </li>
              </ul>
              <button className="btn-secondary" style={{ width: "100%" }}>
                Contact Sales
      ...
      >
        ...
        >
          <div style={{ maxWidth: "280px" }}>
            ...
            >
              The RAG platform that connects your data with AI to deliver
              accurate, trusted answers.
            </p>
            <div
              style={{
                display: "flex",
